...
ADDRESS = os.environ.get("FCRkspJdDbQdQJPaK1K739Qyw3yRYe7dJT")
RPC_URL = "http://127.0.0.1:5170/json_rpc"
...
app.config.update(dict(
    SECRET_KEY=os.environ.get("LOREMEDLIMPANGUG"),
    WTF_CSRF_SECRET_KEY=os.environ.get("LOREMEDLIMPANGUG"),
